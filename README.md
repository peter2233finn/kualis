...
Once the scan is complete, the function vulnfinder.sh can be run. This basically greps issues and then prints them. Its not great and needs improvement but it can find basic issues. This can be run by **./vulnfinder.sh (output foler)**
